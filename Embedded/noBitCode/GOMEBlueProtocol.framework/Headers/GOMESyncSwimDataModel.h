...
@interface GOMESyncSwimItemDataInfoBluetoothModel : GOMEBluetoothBaseModel
/**
...
@interface GOMESyncSwimmingDataInfoBluetoothModel : GOMEBluetoothBaseModel
/**
 年份 | Year
 */
 ...
 */
@property (nonatomic,copy) NSArray <GOMESyncSwimItemDataInfoBluetoothModel *>* swimmingItems;
...
@interface GOMESyncSwimDataModel : NSObject
/**
 ...
 * @return model GOMESyncSwimmingDataInfoBluetoothModel
 */
+ (__kindof GOMESyncSwimmingDataInfoBluetoothModel *)querySwimDataWithTimeStr:(NSString *)timeStr
 ...
 */
+ (NSArray <__kindof GOMESyncSwimmingDataInfoBluetoothModel *>*)querySwimDataWithDateStr:(NSString *)dateStr
                                                                                macAddr:(NSString *)macAddr
