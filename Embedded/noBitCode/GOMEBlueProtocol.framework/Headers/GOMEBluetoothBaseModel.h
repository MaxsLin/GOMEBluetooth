...
@interface GOMEBluetoothBaseModel : NSObject
 ...
 */
+ (GOMEBluetoothBaseModel *_Nullable)queryCurrentModel;
 ...
 */
+ (NSArray <GOMEBluetoothBaseModel *>*_Nullable)queryModelsWithSqlStr:(NSString *_Nullable)sqlStr;
...
+ (BOOL)saveOrUpdateModels:(NSArray <GOMEBluetoothBaseModel *>*_Nullable)models;
 ...
 * @return 是 或 否 | yes or no
 */
+ (BOOL)saveModels:(NSArray <GOMEBluetoothBaseModel *>*_Nullable)models;
 ...
 * @return 是 或 否 | yes or no
 */
+ (BOOL)deleteModels:(NSArray <GOMEBluetoothBaseModel *>*_Nullable)models;
