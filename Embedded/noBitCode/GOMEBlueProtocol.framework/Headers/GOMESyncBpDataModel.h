...
@interface GOMESyncBpDataItemInfoBluetoothModel : GOMEBluetoothBaseModel
...
@interface GOMESyncBpDataInfoBluetoothModel : GOMEBluetoothBaseModel
 ...
 */
@property (nonatomic,copy)   NSArray <GOMESyncBpDataItemInfoBluetoothModel *>* bloodbPressures;
...
@interface GOMESyncBpDataModel : NSObject
/**
 ...
 * @return 一年12个月的血压数据集合,其中GOMESyncBpDataInfoBluetoothModel对象是一天总血压数据模型
 * A 12-month blood pressure data collection, where the GOMESyncBpDataInfoBluetoothModel object is a total blood pressure data model for the day
 */
+ (NSArray <NSArray<__kindof GOMESyncBpDataInfoBluetoothModel *>*> *)queryOneYearBloodPressuresWithYear:(NSInteger)year
 ...
 * @param isQuery 是否查询items | is query items
 * @return 一个月的血压数据集合,其中GOMESyncBpDataInfoBluetoothModel对象是一天总血压数据模型
 * One month blood pressure data set, where the GOMESyncBpDataInfoBluetoothModel object is the total day blood pressure data model
 */
+ (NSArray <__kindof GOMESyncBpDataInfoBluetoothModel *>*)queryOneMonthBloodPressuresWithYear:(NSInteger)year
 ...
 * @param isQuery 是否查询items | is query items
 * @return 一周的血压数据集合,其中GOMESyncBpDataInfoBluetoothModel对象是一天总血压数据模型
 * A week's blood pressure data collection, where the GOMESyncBpDataInfoBluetoothModel object is the total day blood pressure data model
 */
+ (NSArray <__kindof GOMESyncBpDataInfoBluetoothModel *>*)queryOneWeekBloodPressuresWithWeekIndex:(NSInteger)weekIndex
 ...
 */
+ (NSArray<__kindof GOMESyncBpDataInfoBluetoothModel *> *)queryOneDayBloodPressureDetailWithMac:(NSString *)macAddr
                                                                                           year:(NSInteger)year
                                                                                          month:(NSInteger)month
                                                                                            day:(NSInteger)day;
