...
@interface GOMESyncActivityDataInfoBluetoothModel : GOMEBluetoothBaseModel
...
@interface GOMESyncActivityDataModel : NSObject
/**
 ...
 * @return model GOMESyncActivityDataInfoBluetoothModel
 */
+ (__kindof GOMESyncActivityDataInfoBluetoothModel *)queryOneActivityDataWithTimeStr:(NSString *)timeStr
 ...
 */
+ (NSArray <__kindof GOMESyncActivityDataInfoBluetoothModel *>*)queryOneDayActivityDataWithMacAddr:(NSString *)macAddr
                                                                                             year:(NSInteger)year
