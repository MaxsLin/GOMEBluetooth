...
@interface GOMESyncSportDataItemInfoBluetoothModel : GOMEBluetoothBaseModel
...
@interface GOMESyncSportDataInfoBluetoothModel : GOMEBluetoothBaseModel
 ...
 */
@property (nonatomic,copy) NSArray  <GOMESyncSportDataItemInfoBluetoothModel *>* sportItems;
...
@interface GOMESyncSportDataModel : NSObject
/**
 ...
 * @return 一年12个月的运动数据集合，其中GOMESyncSportDataInfoBluetoothModel对象是一天总运动数据模型
 * A 12-month sports data collection, where the GOMESyncSportDataInfoBluetoothModel object is a total day motion data model
 */
+ (NSArray <NSArray <__kindof GOMESyncSportDataInfoBluetoothModel *> *>*)queryOneYearSportsWithYear:(NSInteger)year
 ...
 * @param isQuery 是否查询items | is query items
 * @return 一个月的运动数据集合,其中GOMESyncSportDataInfoBluetoothModel对象是一天总运动数据模型
 * One month of motion data collection, where the GOMESyncSportDataInfoBluetoothModel object is the total day motion data model
 */
+ (NSArray <__kindof GOMESyncSportDataInfoBluetoothModel *>*)queryOneMonthSportsWithYear:(NSInteger)year
 ...
 * @param isQuery 是否查询items | is query items
 * @return 一周的运动数据集合,其中GOMESyncSportDataInfoBluetoothModel对象是一天总运动数据模型
 * A week of motion data collection, where the GOMESyncSportDataInfoBluetoothModel object is the total day motion data model
 */
+ (NSArray <__kindof GOMESyncSportDataInfoBluetoothModel *>*)queryOneWeekSportsWithWeekIndex:(NSInteger)weekIndex
 ...
 */
+ (NSArray <__kindof GOMESyncSportDataInfoBluetoothModel *>*)queryOneDaySportDetailWithMac:(NSString *)macAddr
                                                                                      year:(NSInteger)year
                                                                                     month:(NSInteger)month
                                                                                       day:(NSInteger)day;
 ...
 * @return 所有运动数据的集合 | Collection of all the motion data
 */
+ (NSArray <__kindof GOMESyncSportDataInfoBluetoothModel *>*)queryAllContractedSportsWithMac:(NSString *)macAddr;
