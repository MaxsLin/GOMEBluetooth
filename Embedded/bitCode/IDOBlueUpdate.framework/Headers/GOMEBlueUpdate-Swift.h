...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GOMEBlueUpdate",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
typedef SWIFT_ENUM(NSInteger, DFUError, closed) {
  ...
  DFUErrorRemoteSecureDFUInvalGOMEbject = 15,
...
SWIFT_CLASS("_TtC13GOMEBlueUpdate11DFUFirmware")
...
SWIFT_CLASS("_TtC13GOMEBlueUpdate15DFUFirmwareSize")
...
SWIFT_PROTOCOL("_TtP13GOMEBlueUpdate29DFUPeripheralSelectorDelegate_")
...
SWIFT_CLASS("_TtC13GOMEBlueUpdate21DFUPeripheralSelector")
...
SWIFT_PROTOCOL("_TtP13GOMEBlueUpdate19DFUProgressDelegate_")
...
SWIFT_CLASS("_TtC13GOMEBlueUpdate20DFUServiceController")
...
SWIFT_PROTOCOL("_TtP13GOMEBlueUpdate18DFUServiceDelegate_")
...
///
- (void)dfuError:(enum DFUError)error dGOMEccurWithMessage:(NSString * _Nonnull)message;
@end
...
SWIFT_CLASS("_TtC13GOMEBlueUpdate19DFUServiceInitiator")
...
/// be ignored.
SWIFT_CLASS("_TtC13GOMEBlueUpdate21IntelHex2BinConverter")
...
SWIFT_CLASS("_TtC13GOMEBlueUpdate25LegacyDFUServiceInitiator")
...
/// The Logger delegate.
SWIFT_PROTOCOL("_TtP13GOMEBlueUpdate14LoggerDelegate_")
@protocol LoggerDelegate
...
SWIFT_CLASS("_TtC13GOMEBlueUpdate25SecureDFUServiceInitiator")
