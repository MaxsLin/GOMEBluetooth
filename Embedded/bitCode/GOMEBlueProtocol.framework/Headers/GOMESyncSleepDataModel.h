...
@interface GOMESyncSleepDataItemInfoBluetoothModel : GOMEBluetoothBaseModel
...
@interface GOMESyncSleepDataInfoBluetoothModel : GOMEBluetoothBaseModel
 ...
 */
@property (nonatomic,copy) NSArray <GOMESyncSleepDataItemInfoBluetoothModel *> * sleepItems;
...
@interface GOMESyncSleepDataModel : NSObject
/**
 ...
 * @return 一年12个月的睡眠数据集合,其中GOMESyncSleepDataInfoBluetoothModel对象是一天总睡眠数据模型
 * 12 months of sleep data collection, GOMESyncSleepDataInfoBluetoothModel object is the total day sleep data model
 */
+ (NSArray <NSArray <__kindof GOMESyncSleepDataInfoBluetoothModel *>*>*)queryOneYearSleepsWithYear:(NSInteger)year
 ...
 * @param isQuery 是否查询items | is query items
 * @return 一个月的睡眠数据集合,其中GOMESyncSleepDataInfoBluetoothModel对象是一天总睡眠数据模型
 * A one-month sleep data collection, where the GOMESyncSleepDataInfoBluetoothModel object is the total day sleep data model
 */
+ (NSArray <__kindof GOMESyncSleepDataInfoBluetoothModel *>*)queryOneMonthSleepsWithYear:(NSInteger)year
 ...
 * @param isQuery 是否查询items | is query items
 * @return 一周的睡眠数据集合,其中GOMESyncSleepDataInfoBluetoothModel对象是一天总睡眠数据模型
 * A week's sleep data collection, where the GOMESyncSleepDataInfoBluetoothModel object is the total day sleep data model
 */
+ (NSArray <__kindof GOMESyncSleepDataInfoBluetoothModel *>*)queryOneWeekSleepsWithWeekIndex:(NSInteger)weekIndex
 ...
 */
+ (NSArray <__kindof GOMESyncSleepDataInfoBluetoothModel *>*)queryOneDaySleepsDetailWithMac:(NSString *)macAddr
                                                                                       year:(NSInteger)year
                                                                                      month:(NSInteger)month
                                                                                        day:(NSInteger)day;
 ...
 */
+ (NSArray <__kindof GOMESyncSleepDataInfoBluetoothModel *>*)queryAllContractedSleepsWithMac:(NSString *)macAddr;
