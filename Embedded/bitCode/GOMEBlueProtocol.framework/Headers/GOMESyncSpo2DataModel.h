...
@interface GOMESyncBloodOxygenItemInfoBluetoothModel : GOMEBluetoothBaseModel
...
@interface GOMESyncBloodOxygenDataInfoBluetoothModel : GOMEBluetoothBaseModel
 ...
 */
@property (nonatomic,copy) NSArray <GOMESyncBloodOxygenItemInfoBluetoothModel *>* bloodOxygens;
...
@interface GOMESyncSpo2DataModel : NSObject
/**
 ...
 * @return 一年12个月的血氧数据集合,其中GOMESyncBloodOxygenDataInfoBluetoothModel对象是一天总血氧数据模型
 * Blood oxygen data collection for 12 months a year, where the GOMESyncBloodOxygenDataInfoBluetoothModel object is the total blood oxygen data model for the day
 */
+ (NSArray <NSArray<__kindof GOMESyncBloodOxygenDataInfoBluetoothModel *>*> *)queryOneYearBloodOxygenWithYear:(NSInteger)year
 ...
 * @param isQuery 是否查询items | is query items
 * @return 一个月的血氧数据集合,其中GOMESyncBloodOxygenDataInfoBluetoothModel对象是一天总血氧数据模型
 * A one-month blood oxygen data collection, where the GOMESyncHrDataInfoBluetoothModel object is the total blood oxygen data model for the day
 */
+ (NSArray <__kindof GOMESyncBloodOxygenDataInfoBluetoothModel *>*)queryOneMonthBloodOxygenWithYear:(NSInteger)year
 ...
 * @param isQuery 是否查询items | is query items
 * @return 一周的血氧数据集合,其中GOMESyncBloodOxygenDataInfoBluetoothModel对象是一天总血氧数据模型
 * A week's blood oxygen data collection, where the GOMESyncBloodOxygenDataInfoBluetoothModel object is the total blood oxygen data model for the day
 */
+ (NSArray <__kindof GOMESyncBloodOxygenDataInfoBluetoothModel *>*)queryOneWeekBloodOxygenWithWeekIndex:(NSInteger)weekIndex
 ...
 */
+ (NSArray <__kindof GOMESyncBloodOxygenDataInfoBluetoothModel *>*)queryOneDayBloodOxygenDetailWithMac:(NSString *)macAddr
                                                                                                  year:(NSInteger)year
                                                                                                 month:(NSInteger)month
                                                                                                   day:(NSInteger)day;
 ...
 */
+ (NSArray <__kindof GOMESyncBloodOxygenDataInfoBluetoothModel *>*)queryAllBloodOxygensWithMac:(NSString *)macAddr;
