//
//  GOMESetBuletoothModel.h
//  VeryfitSDK
//
//  Created by Max Mak on 2018/6/13.
...
@interface GOMESetDrinkReminderModeBluetoothModel:GOMEBluetoothBaseModel
/**
 ...
 * @return GOMESetDrinkReminderModeBluetoothModel
 */
+ (__kindof GOMESetDrinkReminderModeBluetoothModel *)currentModel;
@end

#pragma mark ====  设置心率开关同步 model ====
@interface GOMESetV3HeartRateModeBluetoothModel:GOMEBluetoothBaseModel
/**
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetV3HeartRateModeBluetoothModel
 */
+ (__kindof GOMESetV3HeartRateModeBluetoothModel *)currentModel;
@end

#pragma mark ====  设置运动开关 model ====
@interface GOMESetActivitySwitchBluetoothModel:GOMEBluetoothBaseModel
/**
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetActivitySwitchBluetoothModel
 */
+ (__kindof GOMESetActivitySwitchBluetoothModel *)currentModel;

@end


#pragma mark ====  设置血氧开关控制 model ====
@interface GOMESetSpo2SwitchBluetoothModel:GOMEBluetoothBaseModel
/**
 开关 | on off
 */
@property (nonatomic,assign) BOOL onOff;
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetSpo2SwitchBluetoothModel
 */
+ (__kindof GOMESetSpo2SwitchBluetoothModel *)currentModel;

@end

#pragma mark ====  设置呼吸训练 model ====
@interface GOMESetBreatheTrainBluetoothModel:GOMEBluetoothBaseModel
/**
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetBreatheTrainBluetoothModel
 */
+ (__kindof GOMESetBreatheTrainBluetoothModel *)currentModel;
@end

#pragma mark ====  设置走动提醒 model ====
@interface GOMESetWalkReminderBluetoothModel:GOMEBluetoothBaseModel
/**
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetWalkReminderBluetoothModel
 */
+ (__kindof GOMESetWalkReminderBluetoothModel *)currentModel;

@end
#pragma mark ====  设置经期提醒 model ====
@interface GOMESetMenstruationRemindBluetoothModel:GOMEBluetoothBaseModel
/**
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetMenstruationRemindBluetoothModel
 */
+ (__kindof GOMESetMenstruationRemindBluetoothModel *)currentModel;

@end

#pragma mark ====  设置经期 model ====
@interface GOMESetMenstruationInfoBluetoothModel:GOMEBluetoothBaseModel
/**
 开关 | onoff
 */
@property (nonatomic,assign) BOOL onOff;
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetMenstruationInfoBluetoothModel
 */
+ (__kindof GOMESetMenstruationInfoBluetoothModel *)currentModel;

@end

#pragma mark ==== 绑定model ====
@interface GOMESetBindingInfoBluetoothModel:GOMEBluetoothBaseModel
/**
 ...
 * @return GOMESetBindingInfoBluetoothModel
 */
+ (__kindof GOMESetBindingInfoBluetoothModel *)currentModel;
@end

#pragma mark ==== 设置设置睡眠时间段model ====
@interface GOMESetSleepPeriodInfoBluetoothModel:GOMEBluetoothBaseModel
 ...
 * @return GOMESetSleepPeriodInfoBluetoothModel
 */
+ (__kindof GOMESetSleepPeriodInfoBluetoothModel *)currentModel;
@end

#pragma mark ==== 设置血压测量指令model ====
@interface GOMESetBpMeasureInfoBluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetBpMeasureInfoBluetoothModel
 */
+ (__kindof GOMESetBpMeasureInfoBluetoothModel *)currentModel;
@end

#pragma mark ==== 设置表盘参数model ====
@interface GOMESetWatchDiaInfoBluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief  查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetWatchDiaInfoBluetoothModel
 */
+ (__kindof GOMESetWatchDiaInfoBluetoothModel *)currentModel;
@end

#pragma mark ==== 设置马达参数model ====
@interface GOMESetStartMotorInfoBluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetStartMotorInfoBluetoothModel
 */
+ (__kindof GOMESetStartMotorInfoBluetoothModel *)currentModel;
@end

#pragma mark ==== 设置传感器实时数据model ====
@interface GOMESetRealTimeSensorDataInfoBluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetRealTimeSensorDataInfoBluetoothModel
 */
+ (__kindof GOMESetRealTimeSensorDataInfoBluetoothModel *)currentModel;
@end

#pragma mark ==== 设置连接参数信息model ====
@interface GOMESetConnParamInfoBluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetConnParamInfoBluetoothModel
 */
+ (__kindof GOMESetConnParamInfoBluetoothModel *)currentModel;
@end

#pragma mark ==== 设置GPS控制信息model ====
@interface GOMESetGpsControlInfoBluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetGpsControlInfoBluetoothModel
 */
+ (__kindof GOMESetGpsControlInfoBluetoothModel *)currentModel;
@end

#pragma mark ==== 设置GPS信息model ====
@interface GOMESetGpsConfigInfoBluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetGpsConfigInfoBluetoothModel
 */
+ (__kindof GOMESetGpsConfigInfoBluetoothModel *)currentModel;
@end

#pragma mark ==== 设置屏幕亮度model ====
@interface GOMESetScreenBrightnessInfoBluetoothModel:GOMEBluetoothBaseModel
/**
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetScreenBrightnessInfoBluetoothModel
 */
+ (__kindof GOMESetScreenBrightnessInfoBluetoothModel *)currentModel;
@end

#pragma mark ==== 设置天气数据model ====
@interface GOMESetWeatherDataInfoBluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetWeatherDataInfoBluetoothModel
 */
+ (__kindof GOMESetWeatherDataInfoBluetoothModel *)currentModel;
@end

#pragma mark ==== 设置运动快捷模式排序model ====

@interface GOMESetSportSortingItemModel:NSObject
...
@interface GOMESetSportSortingInfoBluetoothModel:GOMEBluetoothBaseModel

/**
 运动模式排序集合最多8个 | Sports mode sort set up to 8
 */
@property (nonatomic,strong)NSArray <GOMESetSportSortingItemModel *>* sportSortingItems;

/**
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetSportSortingInfoBluetoothModel
 */
+ (__kindof GOMESetSportSortingInfoBluetoothModel *)currentModel;

@end

#pragma mark ==== 设置运动快捷模式model ====

@interface GOMESetSportShortcutInfoBluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetSportShortcutInfoBluetoothModel
 */
+ (__kindof GOMESetSportShortcutInfoBluetoothModel *)currentModel;
@end

#pragma mark ==== 设置血压校准model ====
@interface GOMESetBloodPressureInfoBluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetBloodPressureInfoBluetoothModel
 */
+ (__kindof GOMESetBloodPressureInfoBluetoothModel *)currentModel;
@end

#pragma mark ==== 设置快捷方式model ====
@interface GOMESetShortcutInfoBluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetShortcutInfoBluetoothModel
 */
+ (__kindof GOMESetShortcutInfoBluetoothModel *)currentModel;
@end

#pragma mark ==== 设置闹钟model ====
@interface GOMESetAlarmInfoBluetoothModel:GOMEBluetoothBaseModel
 ...
 */
+ (NSArray <GOMESetAlarmInfoBluetoothModel *>*)queryAllAlarms;

/**
 * @brief 查询没有被开启的闹钟集合 | Querying an alarm set that is not turned on
 * @return 闹钟集合 | Alarm clock collection
 */
+ (NSArray <GOMESetAlarmInfoBluetoothModel *>*)queryAllNoOpenAlarms;

@end

#pragma mark ==== 设置时间model ====
@interface GOMESetTimeInfoBluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetTimeInfoBluetoothModel
 */
+ (__kindof GOMESetTimeInfoBluetoothModel *)currentModel;
@end

#pragma mark ==== 设置单位model ====
@interface GOMESetUnitInfoBluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetUnitInfoBluetoothModel
 */
+ (__kindof GOMESetUnitInfoBluetoothModel *)currentModel;
@end

#pragma mark ==== 设置心率区间model ====
@interface GOMESetHrIntervalInfoBluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetHrIntervalInfoBluetoothModel
 */
+ (__kindof GOMESetHrIntervalInfoBluetoothModel *)currentModel;
@end

#pragma mark ==== 设置勿扰模式model ====
@interface GOMESetNoDisturbModeInfoBluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetNoDisturbModeInfoBluetoothModel
 */
+ (__kindof GOMESetNoDisturbModeInfoBluetoothModel *)currentModel;
@end

#pragma mark ==== 设置心率模式model ====
@interface GOMESetHrModeInfoBluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetHRModeInfoBluetoothModel
 */
+ (__kindof GOMESetHrModeInfoBluetoothModel *)currentModel;
@end

#pragma mark ==== 设置手环横竖屏model ====
@interface GOMESetDisplayModeInfoBluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetDisplayModeInfoBluetoothModel
 */
+ (__kindof GOMESetDisplayModeInfoBluetoothModel *)currentModel;
@end

#pragma mark ==== 设置抬腕手势model ====
@interface GOMESetHandUpInfoBuletoothModel : GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetHandUpInfoBuletoothModel
 */
+ (__kindof GOMESetHandUpInfoBuletoothModel *)currentModel;
@end

#pragma mark ==== 设置久坐提醒model ====
@interface GOMESetLongSitInfoBuletoothModel : GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetLongSitInfoBuletoothModel
 */
+ (__kindof GOMESetLongSitInfoBuletoothModel *)currentModel;
@end

#pragma mark ==== 设置天气预报开关model ====
@interface GOMESetWeatherSwitchInfoBluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetWeatherSwitchInfoBluetoothModel
 */
+ (__kindof GOMESetWeatherSwitchInfoBluetoothModel *)currentModel;
@end

#pragma mark ==== 设置相机开关model ====
@interface GOMESetCameraInfoBluetoothModel:GOMEBluetoothBaseModel
...
@interface GOMESetMusicOpenInfoBuletoothModel : GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetMusicOpenInfoBuletoothModel
 */
+ (__kindof GOMESetMusicOpenInfoBuletoothModel *)currentModel;
@end

#pragma mark ==== 设置防止丢失model ====
@interface GOMESetPreventLostInfoBuletoothModel : GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetPreventLostInfoBuletoothModel
 */
+ (__kindof GOMESetPreventLostInfoBuletoothModel *)currentModel;
@end

#pragma mark ==== 设置左右手穿戴model ====
@interface GOMESetLeftOrRightInfoBuletoothModel : GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetLeftOrRightInfoBuletoothModel
 */
+ (__kindof GOMESetLeftOrRightInfoBuletoothModel *)currentModel;
@end

#pragma mark ==== 设置寻找手机model ====
@interface GOMESetFindPhoneInfoBuletoothModel : GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetFindPhoneInfoBuletoothModel
 */
+ (__kindof GOMESetFindPhoneInfoBuletoothModel *)currentModel;
@end

#pragma mark ==== 设置一键呼叫model ====
@interface GOMESetOneKeySosInfoBuletoothModel : GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetOneKeySosInfoBuletoothModel
 */
+ (__kindof GOMESetOneKeySosInfoBuletoothModel *)currentModel;
@end

#pragma mark ==== 设置开启蓝牙配对model ====
@interface GOMESetPairingInfoBuletoothModel : GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetPairingInfoBuletoothModel
 */
+ (__kindof GOMESetPairingInfoBuletoothModel *)currentModel;

@end

#pragma mark ==== 设置智能提醒model ====
@interface GOMESetNoticeInfoBuletoothModel : GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetNoticeInfoBuletoothModel
 */
+ (__kindof GOMESetNoticeInfoBuletoothModel *)currentModel;

@end

#pragma mark ==== 设置用户信息model ====
@interface GOMESetUserInfoBuletoothModel : GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMESetUserInfoBuletoothModel
 */
+ (__kindof GOMESetUserInfoBuletoothModel *)currentModel;


@end


@interface GOMESetInfoBluetoothModel : GOMEBluetoothBaseModel
