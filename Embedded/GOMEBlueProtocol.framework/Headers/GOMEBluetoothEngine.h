//
//  GOMEBluetoothEngine.h
//  VeryfitSDK
//
//  Created by Max Mak on 2018/5/31.
...
@interface GOMEBluetoothManagerInfoEngine : NSObject
 ...
 * 功能列表 | Function List
 */
@property (nonatomic,strong) GOMEGetDeviceFuncBluetoothModel * funcTableModel;

@end

@interface GOMEBluetoothPeripheralInfoEngine : NSObject
...
@interface GOMEBluetoothUserInfoEngine : NSObject
...
@interface GOMEBluetoothAppInfoEngine : NSObject
...
@interface GOMEBluetoothUnitInfoEngine : NSObject
...
@interface GOMEBluetoothEngine : NSObject
+ (GOMEBluetoothEngine *)shareInstance;
- (void)deserialization;
@property (nonatomic,strong) GOMEBluetoothManagerInfoEngine    * managerEngine;
@property (nonatomic,strong) GOMEBluetoothPeripheralInfoEngine * peripheralEngine;
@property (nonatomic,strong) GOMEBluetoothUserInfoEngine       * userEngine;
@property (nonatomic,strong) GOMEBluetoothAppInfoEngine        * appEngine;
@property (nonatomic,strong) GOMEBluetoothUnitInfoEngine       * unitEngine;
@end
