//
//  GOMEWeightBluetoothModel.h
//  GOMEBluetooth
//
//  Created by Max Mak on 2018/10/27.
...
@interface GOMEWeightBluetoothModel : GOMEBluetoothBaseModel
 ...
 * @return GOMEUserWeightModel
 */
+ (__kindof GOMEWeightBluetoothModel *)currentModel;
 ...
 * @return GOMEUserWeightModel
 */
+ (NSArray <__kindof GOMEWeightBluetoothModel *>*)querySevenTimesRecentlyWithDateStr:(NSString *)dateStr;
 ...
 */
+ (__kindof GOMEWeightBluetoothModel *)queryOneDayDataWithYear:(NSInteger)year
