...
@interface GOMESyncPressureItemInfoBluetoothModel : GOMEBluetoothBaseModel
...
@interface GOMESyncPressureDataInfoBluetoothModel : GOMEBluetoothBaseModel
 ...
 */
@property (nonatomic,copy) NSArray <GOMESyncPressureItemInfoBluetoothModel *>* pressures;

@end

@interface GOMESyncPressureDataModel : NSObject
/**
 ...
 * @return 一年12个月的压力数据集合,其中GOMESyncPressureDataInfoBluetoothModel对象是一天总血氧数据模型
 * pressure data collection for 12 months a year, where the GOMESyncPressureDataInfoBluetoothModel object is the total pressure data model for the day
 */
+ (NSArray <NSArray<__kindof GOMESyncPressureDataInfoBluetoothModel *>*> *)queryOneYearPressureWithYear:(NSInteger)year
 ...
 * @param isQuery 是否查询items | is query items
 * @return 一个月的压力数据集合,其中GOMESyncPressureDataInfoBluetoothModel对象是一天总压力数据模型
 * A one-month pressure data collection, where the GOMESyncPressureDataInfoBluetoothModel object is the total pressure data model for the day
 */
+ (NSArray <__kindof GOMESyncPressureDataInfoBluetoothModel *>*)queryOneMonthPressureWithYear:(NSInteger)year
 ...
 * @param isQuery 是否查询items | is query items
 * @return 一周的压力数据集合,其中GOMESyncPressureDataInfoBluetoothModel对象是一天总压力数据模型
 * A week's pressure data collection, where the GOMESyncPressureDataInfoBluetoothModel object is the total pressure data model for the day
 */
+ (NSArray <__kindof GOMESyncPressureDataInfoBluetoothModel *>*)queryOneWeekPressureWithWeekIndex:(NSInteger)weekIndex
 ...
 */
+ (NSArray <__kindof GOMESyncPressureDataInfoBluetoothModel *>*)queryOneDayPressureDetailWithMac:(NSString *)macAddr
                                                                                            Year:(NSInteger)year
                                                                                           month:(NSInteger)month
                                                                                             day:(NSInteger)day;
 ...
 */
+ (NSArray <__kindof GOMESyncPressureDataInfoBluetoothModel *>*)queryAllPressuresWithMac:(NSString *)macAddr;
