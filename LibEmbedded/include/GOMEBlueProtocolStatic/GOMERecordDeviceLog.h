//
//  GOMERecordDeviceLog.h
//  GOMEBluetooth
//
//  Created by Max Mak on 2018/9/25.
...
#else
#import "GOMELogEnum.h"
#endif

@interface GOMERecordDeviceLog : NSObject
 ...
 */
+ (void)recordBlueLogWithType:(GOME_RECORD_LOG_TYPE)type
