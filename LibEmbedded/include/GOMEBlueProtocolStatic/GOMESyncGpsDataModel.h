...
@interface GOMESyncGpsDataItemInfoBluetoothModel : GOMEBluetoothBaseModel
...
@interface GOMESyncGpsDataInfoBluetoothModel : GOMEBluetoothBaseModel
 ...
 */
@property (nonatomic,copy) NSArray <GOMESyncGpsDataItemInfoBluetoothModel *>* gpsItems;

@end

@interface GOMESyncGpsDataModel : NSObject
/**
 ...
 */
+ (__kindof GOMESyncGpsDataInfoBluetoothModel *)queryOneActivityCoordinatesWithTimeStr:(NSString *)timeStr
