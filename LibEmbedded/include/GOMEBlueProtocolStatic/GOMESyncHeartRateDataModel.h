//
//  GOMESyncHeartRateDataModel.h
//  GOMEBluetoothInternal
//
//  Created by Max Mak on 2019/8/6.
...
@interface GOMESyncHrDataItemInfoBluetoothModel : GOMEBluetoothBaseModel
...
@interface GOMESyncHrDataInfoBluetoothModel : GOMEBluetoothBaseModel
 ...
 */
@property (nonatomic,copy) NSArray <GOMESyncHrDataItemInfoBluetoothModel *>* heartRates;
...
@interface GOMESyncSecHrDataItemInfoBluetoothModel : GOMEBluetoothBaseModel
/**
...
@interface GOMESyncSecHrDataInfoBluetoothModel : GOMEBluetoothBaseModel
/**
 心率数据包数量 | Heart Rate Packets
 */
@property (nonatomic,assign) NSInteger  itemsCount;
 ...
 * converted into model collections. You need to query itemModel to assign current attributes.
 */
@property (nonatomic,copy) NSArray <GOMESyncSecHrDataItemInfoBluetoothModel *>* heartRates;
...
@interface GOMESyncHeartRateDataModel : NSObject
 ...
 * @return 一年12个月的心率数据集合,其中GOMESyncHrDataInfoBluetoothModel对象是一天总心率数据模型
 * Heart rate data collection for 12 months a year, where the GOMESyncHrDataInfoBluetoothModel object is the total heart rate data model for the day
 */
+ (NSArray <NSArray<__kindof GOMESyncHrDataInfoBluetoothModel *>*> *)queryOneYearHearRatesWithYear:(NSInteger)year
 ...
 * @param isQuery 是否查询items | is query items
 * @return 一个月的心率数据集合,其中GOMESyncHrDataInfoBluetoothModel对象是一天总心率数据模型
 * A one-month heart rate data collection, where the GOMESyncHrDataInfoBluetoothModel object is the total heart rate data model for the day
 */
+ (NSArray <__kindof GOMESyncHrDataInfoBluetoothModel *>*)queryOneMonthHearRatesWithYear:(NSInteger)year
 ...
 * @param isQuery 是否查询items | is query items
 * @return 一周的心率数据集合,其中GOMESyncHrDataInfoBluetoothModel对象是一天总心率数据模型
 * A week's heart rate data collection, where the GOMESyncHrDataInfoBluetoothModel object is the total heart rate data model for the day
 */
+ (NSArray <__kindof GOMESyncHrDataInfoBluetoothModel *>*)queryOneWeekHearRatesWithWeekIndex:(NSInteger)weekIndex
 ...
 */
+ (NSArray<__kindof GOMESyncHrDataInfoBluetoothModel *> *)queryOneDayHearRatesDetailWithMac:(NSString *)macAddr
                                                                                       year:(NSInteger)year
                                                                                      month:(NSInteger)month
                                                                                        day:(NSInteger)day;
 ...
 */
+ (NSArray <__kindof GOMESyncHrDataInfoBluetoothModel *>*)queryAllContractedHearRatesWithMac:(NSString *)macAddr;
 ...
 * @param macAddr mac 地址 | mac address
 * @param isQuery 是否查询items | is query items
 * @return 一年12个月的秒钟心率数据集合,其中GOMESyncSecHrDataInfoBluetoothModel对象是一天总心率数据模型
 * second heart rate data collection for 12 months a year, where the GOMESyncSecHrDataInfoBluetoothModel object is the total heart rate data model for the day
 */
+ (NSArray <NSArray<__kindof GOMESyncSecHrDataInfoBluetoothModel *>*> *)queryOneYearSecHearRatesWithYear:(NSInteger)year
                                                                                                macAddr:(NSString *)macAddr
                                                                                           isQueryItems:(BOOL)isQuery;
 ...
 * Pointer to all date collections for the current query month (format: [10/01...10/31])
 * @param isQuery 是否查询items | is query items
 * @return 一个月的秒钟心率数据集合,其中GOMESyncSecHrDataInfoBluetoothModel对象是一天总心率数据模型
 * one-month second heart rate data collection, where the GOMESyncSecHrDataInfoBluetoothModel object is the total heart rate data model for the day
 */
+ (NSArray <__kindof GOMESyncSecHrDataInfoBluetoothModel *>*)queryOneMonthSecHearRatesWithYear:(NSInteger)year
                                                                                         month:(NSInteger)month
                                                                                       macAddr:(NSString *)macAddr
                                                                                  datesOfMonth:(NSArray <NSString *>**)dates
                                                                                  isQueryItems:(BOOL)isQuery;
 ...
 * Pointer to all date collections for the current query week (format: [10/01...10/07])
 * @param isQuery 是否查询items | is query items
 * @return 一周的秒钟心率数据集合,其中GOMESyncSecHrDataInfoBluetoothModel对象是一天总心率数据模型
 * one week second heart rate data collection, where the GOMESyncSecHrDataInfoBluetoothModel object is the total heart rate data model for the day
 */
+ (NSArray <__kindof GOMESyncSecHrDataInfoBluetoothModel *>*)queryOneWeekSecHearRatesWithWeekIndex:(NSInteger)weekIndex
                                                                                     weekStartDay:(NSInteger)weekStartDay
                                                                                          macAddr:(NSString *)macAddr
                                                                                      datesOfWeek:(NSArray <NSString *>**)dates
                                                                                     isQueryItems:(BOOL)isQuery;
 ...
 */
+ (NSArray<__kindof GOMESyncSecHrDataInfoBluetoothModel *> *)queryOneDaySecHearRatesDetailWithMac:(NSString *)macAddr
                                                                                    year:(NSInteger)year
                                                                                   month:(NSInteger)month
                                                                                     day:(NSInteger)day
                                                                            isQueryItems:(BOOL)isQuery;
 ...
 */
+ (NSArray <__kindof GOMESyncSecHrDataInfoBluetoothModel *>*)queryAllSecHearRatesWithMac:(NSString *)macAddr;
 ...
 * @return 所有心率数据的集合 | Collection of all heart rate data
 */
+ (NSArray <__kindof GOMESyncSecHrDataInfoBluetoothModel *>*)queryAllContractedSecHearRatesWithMac:(NSString *)macAddr;
