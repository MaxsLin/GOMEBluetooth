...
@interface GOMEGetDownLanguageBluetoothModel:GOMEBluetoothBaseModel
/**
 * 当前使用的语言 | use lang
 */
 ...
 * @return GOMEGetDownLanguageBluetoothModel
 */
+ (__kindof GOMEGetDownLanguageBluetoothModel *)currentModel;

@end

#pragma mark ====  默认运动类型值 model ====
@interface GOMEGetDefaultSportTypeBluetoothModel:GOMEBluetoothBaseModel
/**
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetDefaultSportTypeBluetoothModel
 */
+ (__kindof GOMEGetDefaultSportTypeBluetoothModel *)currentModel;

@end

#pragma mark ====  手环检查版本号 model ====
@interface GOMECheckUpdateBluetoothModel:GOMEBluetoothBaseModel
/**
 * app 响应状态 | flag code
...
@interface GOMEGetFiveHrReplyInfoBluetoothModel:GOMEBluetoothBaseModel
/**
...
@interface GOMEGetVersionInfoBluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetVersionInfoBluetoothModel
 */
+ (__kindof GOMEGetVersionInfoBluetoothModel *)currentModel;

@end

#pragma mark ==== 获取GPS状态model ====
@interface GOMEGetGpsStatusBluetoothModel:GOMEBluetoothBaseModel
/**
...
@interface GOMEGetHotStartParamBluetoothModel:GOMEBluetoothBaseModel
/**
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetHotStartParamBluetoothModel
 */
+ (__kindof GOMEGetHotStartParamBluetoothModel *)currentModel;

@end

#pragma mark ==== 获取GPS信息model ====
@interface GOMEGetGpsInfoBluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief  查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetGpsInfoBluetoothModel
 */
+ (__kindof GOMEGetGpsInfoBluetoothModel *)currentModel;

@end

#pragma mark ==== 获取hid信息model ====
@interface GOMEGetHidInfoBluetoothModel:GOMEBluetoothBaseModel
 ...
 * @return GOMEGetHidInfoBluetoothModel
 */
+ (__kindof GOMEGetHidInfoBluetoothModel *)currentModel;

@end

#pragma mark ==== 获取活动和GPS个数信息model ====
@interface GOMEGetActivityCountBluetoothModel:GOMEBluetoothBaseModel
 ...
 * @return GOMEGetActivityCountBluetoothModel
 */
+ (__kindof GOMEGetActivityCountBluetoothModel *)currentModel;

@end

#pragma mark ==== 获取加速度传感器参数信息model ====
@interface GOMEGetGsensorParamBluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象 (暂停使用,无效)
 * Query the database, if the query does not initialize a new model object (suspended, invalid)
 * @return GOMEGetHrSensorParamBluetoothModel
 */
+ (__kindof GOMEGetGsensorParamBluetoothModel *)currentModel;
@end

#pragma mark ==== 获取心率传感器参数信息model ====
@interface GOMEGetHrSensorParamBluetoothModel:GOMEBluetoothBaseModel
 ...
 * @return GOMEGetHrSensorParamBluetoothModel
 */
+ (__kindof GOMEGetHrSensorParamBluetoothModel *)currentModel;

@end

#pragma mark ==== 获取设备时间信息model ====
@interface GOMEGetDeviceTimeBluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象 *(暂停使用,无效)
 * Query the database, if the query does not initialize a new model object (suspended, invalid)
 * @return GOMEGetDeviceTimeBluetoothModel
 */
+ (__kindof GOMEGetDeviceTimeBluetoothModel *)currentModel;
@end

#pragma mark ==== 获取实时数据信息model ====
@interface GOMEGetLiveDataBluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetLiveDataBluetoothModel
 */
+ (__kindof GOMEGetLiveDataBluetoothModel *)currentModel;

@end

#pragma mark ==== 获取第27个功能表model ====

@interface GOMEGetFuncTable27BluetoothModel : GOMEBluetoothBaseModel
/**
 * 泰国语
 * thai
 */
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetFuncTable27BluetoothModel
 */
+ (__kindof GOMEGetFuncTable27BluetoothModel *)currentModel;
@end

#pragma mark ==== 获取第26个功能表model ====

@interface GOMEGetFuncTable26BluetoothModel : GOMEBluetoothBaseModel
/**
 * 支持恢复出厂设置,用于自动解绑
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetFuncTable26BluetoothModel
 */
+ (__kindof GOMEGetFuncTable26BluetoothModel *)currentModel;
@end

#pragma mark ==== 获取第25个功能表model ====

@interface GOMEGetFuncTable25BluetoothModel:GOMEBluetoothBaseModel
/**
 椭圆机 | elliptical
 */
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetFuncTable25BluetoothModel
 */
+ (__kindof GOMEGetFuncTable25BluetoothModel *)currentModel;

@end

#pragma mark ==== 获取第24个功能表model ====

@interface GOMEGetFuncTable24BluetoothModel:GOMEBluetoothBaseModel
/**
 户外跑步 | outdoor run
 */
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetFuncTable24BluetoothModel
 */
+ (__kindof GOMEGetFuncTable24BluetoothModel *)currentModel;

@end

#pragma mark ==== 获取第23个功能表model ====
@interface GOMEGetFuncTable23BluetoothModel:GOMEBluetoothBaseModel
/**
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetFuncTable23BluetoothModel
 */
+ (__kindof GOMEGetFuncTable23BluetoothModel *)currentModel;

@end

#pragma mark ==== 获取22功能列表信息model ====
@interface GOMEGetFuncTable22BluetoothModel:GOMEBluetoothBaseModel
/**
 连接后自动配对 | auto pair
 */
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetFuncTable22BluetoothModel
 */
+ (__kindof GOMEGetFuncTable22BluetoothModel *)currentModel;
@end

#pragma mark ==== 获取21功能列表信息model ====
@interface GOMEGetFuncTable21BluetoothModel:GOMEBluetoothBaseModel
/**
 chatwork
 */
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetFuncTable21BluetoothModel
 */
+ (__kindof GOMEGetFuncTable21BluetoothModel *)currentModel;
@end

#pragma mark ==== 获取20功能列表信息model ====
@interface GOMEGetFuncTable20BluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetFuncTable20BluetoothModel
 */
+ (__kindof GOMEGetFuncTable20BluetoothModel *)currentModel;

@end

#pragma mark ==== 获取19功能列表信息model ====
@interface GOMEGetFuncTable19BluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetFuncTable19BluetoothModel
 */
+ (__kindof GOMEGetFuncTable19BluetoothModel *)currentModel;

@end

#pragma mark ==== 获取18列表信息model ====
@interface GOMEGetFuncTable18BluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetFuncTable18BluetoothModel
 */
+ (__kindof GOMEGetFuncTable18BluetoothModel *)currentModel;

@end

#pragma mark ==== 获取17功能列表信息model ====
@interface GOMEGetFuncTable17BluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetFuncTable17BluetoothModel
 */
+ (__kindof GOMEGetFuncTable17BluetoothModel *)currentModel;

@end

#pragma mark ==== 获取16功能列表信息model ====
@interface GOMEGetFuncTable16BluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetFuncTable16BluetoothModel
 */
+ (__kindof GOMEGetFuncTable16BluetoothModel *)currentModel;

@end

#pragma mark ==== 获取15功能列表信息model ====
@interface GOMEGetFuncTable15BluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetFuncTable15BluetoothModel
 */

+ (__kindof GOMEGetFuncTable15BluetoothModel *)currentModel;
@end

#pragma mark ==== 获取14功能列表信息model ====
@interface GOMEGetFuncTable14BluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetFuncTable14BluetoothModel
 */
+ (__kindof GOMEGetFuncTable14BluetoothModel *)currentModel;

@end

#pragma mark ==== 获取13功能列表信息model ====
@interface GOMEGetFuncTable13BluetoothModel:GOMEBluetoothBaseModel
 ...
 *@brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 *@return GOMEGetFuncTable13BluetoothModel
 */
+ (__kindof GOMEGetFuncTable13BluetoothModel *)currentModel;

@end

#pragma mark ==== 获取12功能列表信息model ====
@interface GOMEGetFuncTable12BluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetFuncTable12BluetoothModel
 */
+ (__kindof GOMEGetFuncTable12BluetoothModel *)currentModel;

@end

#pragma mark ==== 获取11功能列表信息model ====
@interface GOMEGetFuncTable11BluetoothModel:GOMEBluetoothBaseModel
...
/**
  * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
  * @return GOMEGetFuncTable11BluetoothModel
 */
+ (__kindof GOMEGetFuncTable11BluetoothModel *)currentModel;

@end

#pragma mark ==== 获取10功能列表信息model ====
@interface GOMEGetFuncTable10BluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetFuncTable10BluetoothModel
 */
+ (__kindof GOMEGetFuncTable10BluetoothModel *)currentModel;

@end

#pragma mark ==== 获取9功能列表信息model ====
@interface GOMEGetFuncTable9BluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetFuncTable9BluetoothModel
 */
+ (__kindof GOMEGetFuncTable9BluetoothModel *)currentModel;

@end

#pragma mark ==== 获取8功能列表信息model ====
@interface GOMEGetFuncTable8BluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetFuncTable8BluetoothModel
 */
+ (__kindof GOMEGetFuncTable8BluetoothModel *)currentModel;
@end

#pragma mark ==== 获取7功能列表信息model ====
@interface GOMEGetFuncTable7BluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetFuncTable7BluetoothModel
 */
+ (__kindof GOMEGetFuncTable7BluetoothModel *)currentModel;
@end

#pragma mark ==== 获取6功能列表信息model ====
@interface GOMEGetFuncTable6BluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief  查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetFuncTable6BluetoothModel
 */
+ (__kindof GOMEGetFuncTable6BluetoothModel *)currentModel;
@end

#pragma mark ==== 获取5功能列表信息model ====
@interface GOMEGetFuncTable5BluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetFuncTable5BluetoothModel
 */
+ (__kindof GOMEGetFuncTable5BluetoothModel *)currentModel;
@end

#pragma mark ==== 获取4功能列表信息model ====
@interface GOMEGetFuncTable4BluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetFuncTable4BluetoothModel
 */
+ (__kindof GOMEGetFuncTable4BluetoothModel *)currentModel;

@end

#pragma mark ==== 获取3功能列表信息model ====
@interface GOMEGetFuncTable3BluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetFuncTable3BluetoothModel
 */
+ (__kindof GOMEGetFuncTable3BluetoothModel *)currentModel;

@end


#pragma mark ==== 获取2功能列表信息model ====
@interface GOMEGetFuncTable2BluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetFuncTable2BluetoothModel
 */
+ (__kindof GOMEGetFuncTable2BluetoothModel *)currentModel;
@end

#pragma mark ==== 获取1功能列表信息model ====
@interface GOMEGetFuncTable1BluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetFuncTable1BluetoothModel
 */
+ (__kindof GOMEGetFuncTable1BluetoothModel *)currentModel;
@end

#pragma mark ==== 获取功能列表信息model ====
@interface GOMEGetDeviceFuncBluetoothModel:GOMEBluetoothBaseModel

/**
 1功能列表 语言1 | 1 func table
 */
@property (nonatomic,strong) GOMEGetFuncTable1BluetoothModel       * funcTable1Model;

/**
 2功能列表 语言2 | 2 func table
 */
@property (nonatomic,strong) GOMEGetFuncTable2BluetoothModel       * funcTable2Model;

/**
 3功能列表 语言3 | 3 func table
 */
@property (nonatomic,strong) GOMEGetFuncTable3BluetoothModel       * funcTable3Model;

/**
 4功能列表 | 4 func table
 */
@property (nonatomic,strong) GOMEGetFuncTable4BluetoothModel       * funcTable4Model;

/**
 5功能列表 | 5 func table
 */
@property (nonatomic,strong) GOMEGetFuncTable5BluetoothModel       * funcTable5Model;

/**
 6功能列表 闹钟功能 | 6 func table
 */
@property (nonatomic,strong) GOMEGetFuncTable6BluetoothModel       * funcTable6Model;

/**
 7功能列表 来电提醒 | 7 func table
 */
@property (nonatomic,strong) GOMEGetFuncTable7BluetoothModel       * funcTable7Model;

/**
 8功能列表 智能提醒1 | 8 func table
 */
@property (nonatomic,strong) GOMEGetFuncTable8BluetoothModel       * funcTable8Model;

/**
 9功能列表 智能提醒2 | 9 func table
 */
@property (nonatomic,strong) GOMEGetFuncTable9BluetoothModel       * funcTable9Model;

/**
 10功能列表 智能提醒3 | 10 func table
 */
@property (nonatomic,strong) GOMEGetFuncTable10BluetoothModel      * funcTable10Model;

/**
 11功能列表 久坐、防丢 | 11 func table
 */
@property (nonatomic,strong) GOMEGetFuncTable11BluetoothModel      * funcTable11Model;

/**
 12功能列表 短信号码 | 12 func table
 */
@property (nonatomic,strong) GOMEGetFuncTable12BluetoothModel      * funcTable12Model;

/**
 13功能列表 静态心率、显示模式 | 13 func table
 */
@property (nonatomic,strong) GOMEGetFuncTable13BluetoothModel      * funcTable13Model;

/**
 14功能列表 运动模式1 | 14 func table
 */
@property (nonatomic,strong) GOMEGetFuncTable14BluetoothModel      * funcTable14Model;

/**
 15功能列表 运动模式2 | 15 func table
 */
@property (nonatomic,strong) GOMEGetFuncTable15BluetoothModel      * funcTable15Model;

/**
 16功能列表 运动模式3 | 16 func table
 */
@property (nonatomic,strong) GOMEGetFuncTable16BluetoothModel      * funcTable16Model;

/**
 17功能列表 运动模式4 | 17 func table
 */
@property (nonatomic,strong) GOMEGetFuncTable17BluetoothModel      * funcTable17Model;

/**
 18功能列表 表盘、血压 | 18 func table
 */
@property (nonatomic,strong) GOMEGetFuncTable18BluetoothModel      * funcTable18Model;

/**
 19功能列表 GPS、亮度 | 19 func table
 */
@property (nonatomic,strong) GOMEGetFuncTable19BluetoothModel      * funcTable19Model;

/**
 20功能列表 女性健康、运动排序 | 20 func table
 */
@property (nonatomic,strong) GOMEGetFuncTable20BluetoothModel      * funcTable20Model;

/**
 21功能列表 | 21 func table
 */
@property (nonatomic,strong) GOMEGetFuncTable21BluetoothModel      * funcTable21Model;

/**
 22功能列表 连接后自动配对、v3数据 | 22 func table
 */
@property (nonatomic,strong) GOMEGetFuncTable22BluetoothModel      * funcTable22Model;

/**
 23功能列表 走动提醒、呼吸训练 | 23 func table
 */
@property (nonatomic,strong) GOMEGetFuncTable23BluetoothModel      * funcTable23Model;

/**
 24功能列表 运动模式5 | 24 func table
 */
@property (nonatomic,strong) GOMEGetFuncTable24BluetoothModel      * funcTable24Model;

/**
 25功能列表 运动模式6 | 25 func table
 */
@property (nonatomic,strong) GOMEGetFuncTable25BluetoothModel      * funcTable25Model;

/**
 26功能列表 运动模式6 | 26 func table
 */
@property (nonatomic,strong) GOMEGetFuncTable26BluetoothModel      * funcTable26Model;

/**
 27功能列表 语言4 | 27 func table
 */
@property (nonatomic,strong) GOMEGetFuncTable27BluetoothModel      * funcTable27Model;
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetDeviceFuncBluetoothModel
 */
+ (__kindof GOMEGetDeviceFuncBluetoothModel *)currentModel;
...
@interface GOMEGetDeviceInfoBluetoothModel:GOMEBluetoothBaseModel
 ...
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetDeviceInfoBluetoothModel
 */
+ (__kindof GOMEGetDeviceInfoBluetoothModel *)currentModel;

/**
 * @brief 查询本地所有设备信息（不包括Mac地址不存在的设备）
 * Query all local device information (excluding devices where Mac addresses do not exist)
 * @return GOMEGetDeviceInfoBluetoothModel array
 */
+ (NSArray <__kindof GOMEGetDeviceInfoBluetoothModel *>*)queryAllDeviceModels;

@end

#pragma mark ==== 获取mac地址model ====
@interface GOMEGetMacAddrInfoBluetoothModel:GOMEBluetoothBaseModel

/**
 * @brief 查询数据库,如果查询不到初始化新的model对象
 * Query the database, if the query does not initialize a new model object
 * @return GOMEGetMacAddrInfoBluetoothModel
 */
+ (__kindof GOMEGetMacAddrInfoBluetoothModel *)currentModel;
@end

@interface GOMEGetInfoBluetoothModel : GOMEBluetoothBaseModel
